...
from libs.apriltag_perf.cache import CacheConfig, DetectionCache, build_cache_key
from libs.apriltag_perf.prefilter import PrefilterConfig, prefilter_pass
...
class CachedAprilTagDetector:
    ...
    def detect_path(self, image_path: Path) -> DetectionResult:
        ...
        try:
            ...
            from utils import detect_apriltag_corners
