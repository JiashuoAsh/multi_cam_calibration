...
用法：
    python -m mcca.tools.verify_corner_order
...
def verify_corner_order() -> bool:
    ...
    if match_count == 4:
        ...
        print("   需要调整 detect_apriltag_corners() 内的角点顺序映射")
        print("   当前映射: [2,3,0,1]")
